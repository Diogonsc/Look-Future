...
export function HeroSection() {
  return (
    <section
      id="inicio"
      className="relative min-h-screen flex items-center justify-center overflow-hidden pt-4"
    >
          ...
          <div className="text-left space-y-6 animate-fade-in-up">
            <div className="space-y-2">
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black leading-tight">
                ...
                <br />
                <span className="text-foreground/90">Modernidade e</span>
                <br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button
                className="px-8 py-4 bg-primary text-white font-semibold rounded-lg hover:bg-primary/90 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                onClick={() => {
              ...
              <button
                className="px-8 py-4 border-2 border-primary/30 text-primary font-semibold rounded-lg hover:bg-primary/10 transition-all duration-300 transform hover:scale-105"
                onClick={() => {
